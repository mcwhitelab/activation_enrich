...
# Remember to request 128GB when getting an Rstudio session to handle reading larger .pkl files

# required installation to read .pkl files 
...
# For converting between uniprot and entrez id
...
# The thing is, this is kind of hard to disentangle. 
